    ...
    <div className="bg-[#0E0E0E] min-h-screen text-white">
      ...
      <div className="bg-[#0A0A0A] pt-8 md:pt-12 pb-8 px-6 border-b border-white/5 relative">
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          >
            Discover sneakers everyday essentials curated for all.
          </motion.p>
        ...
        <div className="flex-1 w-full">
          ...
          {isLoading ? (
            ...
            <div className="py-20 md:py-32 flex flex-col items-center text-center border-t border-white/10">
              ...
              <p className="text-gray-400 max-w-md mx-auto mb-10 text-sm md:text-base">Try adjusting your filters or explore our most popular sneakers. We receive new arrivals weekly.</p>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end">
        <a 
          href={`https://wa.me/${brand.whatsappNumber}?text=Hello%20Creme%20Kicks%20,%20I'm%20interested%20in%20ordering%20footwear%20from%20your%20website.%20Could%20you%20assist%20me%20with%20availability,%20sizing,%20and%20delivery?%20Thank%20you.`}
          target="_blank" rel="noreferrer"
